...
function syncChild(childId) { onSnapshot(doc(db,"skolschema",childId), snapshot => { const week=fromFirestoreWeek(snapshot.data()?.week);if(week)schedules[childId]=week;if(child===childId)render(); }, () => {}); }
